...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t =
        "undefined" != typeof globalThis ? globalThis : t || self).TomSelect =
        e());
})(this, function () {
  "use strict";
  function t(t, e) {
  ...
  const i = (t) =>
    ...
    o = (t) => new Set(t).size !== t.length,
    r = (t) => (t + "").replace(/([\$\(\)\*\+\.\?\[\]\^\{\|\}\\])/gu, "\\$1"),
    l = (t) => t.reduce((t, e) => Math.max(t, a(e)), 0),
    a = (t) => c(t).length,
    c = (t) => Array.from(t),
    d = (t) => {
  ...
  const v = new RegExp(Object.keys(g).join("|") + "|[̀-ͯ·ʾʼ]", "gu"),
    m = (t, e = "NFKD") => t.normalize(e),
    y = (t) => c(t).reduce((t, e) => t + O(e), ""),
    O = (t) => (
      (t = m(t)
        .toLowerCase()
        .replace(v, (t) => g[t] || "")),
        ...
        for (const [e, i] of t)
          for (let t = e; t <= i; t++) {
            ...
            i != e.toLowerCase() &&
              (i.length > 3 ||
                (0 != i.length &&
                  (yield { folded: i, composed: e, code_point: t })));
          }
      })(t))
      ...
      i(
        d(t).map((t) =>
          ((t, e = 1) => {
            let i = 0;
            return (
              (t = t.map((t) => (p[t] && (i += t.length), p[t] || t))),
              i >= e ? s(t) : ""
            );
          })(t, e)
        )
  ...
  class A {
    ...
    clone(t, e) {
      ...
      let o = e.substr.substring(0, t - n.start),
        r = o.length;
      return (
  ...
  const C = (t) => {
      ...
      for (let e = 0; e < t.length; e++) {
        ...
        const o = t.substring(e, e + 1),
          r = n ? n[0] : null;
        let l = [],
          a = new Set();
        for (const t of s) {
          const i = t.last();
          if (!i || 1 == i.length || i.end <= e)
            if (r) {
              const i = r.length;
              t.add({ start: e, end: e + i, length: i, substr: r }), a.add("1");
            } else
              t.add({ start: e, end: e + 1, length: 1, substr: o }), a.add("2");
          else if (r) {
            let s = t.clone(e, i);
            const n = r.length;
    ...
    x = (t, e) => {
      if (t) {
        for (var i, s = e.split("."); (i = s.shift()) && (t = t[i]); );
        return t;
      }
    },
    L = (t, e, i) => {
      ...
      return t
        ? ((t += ""),
          null == e.regex || -1 === (n = t.search(e.regex))
            ? 0
            : ((s = e.string.length / t.length), 0 === n && (s += 0.5), s * i))
        : 0;
    },
    k = (t, e) => {
      var i = t[e];
    ...
    P = (t, e) =>
      "number" == typeof t && "number" == typeof e
        ? t > e
          ...
          ? -1
          : 0
        : (t = y(t + "").toLowerCase()) > (e = y(e + "").toLowerCase())
        ? 1
        : e > t
        ? -1
        : 0;
  class T {
      ...
      return (
        ...
        n.forEach((t) => {
          let i,
            n = null,
            l = null;
          o && (i = t.match(o)) && ((n = i[1]), (t = i[2])),
            t.length > 0 &&
              ((l = this.settings.diacritics ? C(t) || null : r(t)),
              l && e && (l = "\\b" + l)),
            s.push({
              string: t,
    ...
    _getSortFunction(t) {
      ...
      const s = this,
        n = t.options,
        o = !t.query && n.sort_empty ? n.sort_empty : n.sort;
      if ("function" == typeof o) return o.bind(this);
      const r = function (e, i) {
        return "$score" === e ? i.score : t.getAttrFn(s.items[i.id], e);
      };
      ...
      return i.length
        ? function (t, e) {
            ...
            for (let o of i) {
              if (
                ((n = o.field),
                (s = ("desc" === o.direction ? -1 : 1) * P(r(n, t), r(n, e))))
              )
                return s;
            }
            return 0;
    ...
    prepareSearch(t, e) {
      ...
      if ((k(s, "sort"), k(s, "sort_empty"), s.fields)) {
        ...
        const t = [];
        s.fields.forEach((e) => {
          "string" == typeof e && (e = { field: e, weight: 1 }),
            t.push(e),
      ...
      return {
        ...
        tokens: this.tokenize(t, s.respect_word_boundaries, i),
        total: 0,
        items: [],
        weights: i,
        getAttrFn: s.nesting ? x : F,
      };
    }
    search(t, e) {
      var i,
      ...
      t.length
        ? E(n.items, (t, n) => {
            (i = o(t)),
              (!1 === e.filter || i > 0) && s.items.push({ score: i, id: n });
          })
        : E(n.items, (t, e) => {
      ...
      return (
        ...
        "number" == typeof e.limit && (s.items = s.items.slice(0, e.limit)),
        s
      );
    }
  }
  const V = (t, e) => {
    ...
    j = (t) => "string" == typeof t && t.indexOf("<") > -1,
    q = (t, e) => {
  ...
  const X = (t) => (null == t ? null : Y(t)),
    Y = (t) => ("boolean" == typeof t ? (t ? "1" : "0") : t + ""),
    Z = (t) =>
      (t + "")
        .replace(/&/g, "&amp;")
        .replace(/</g, "&lt;")
      ...
      return function (s, n) {
        ...
        i && ((o.loading = Math.max(o.loading - 1, 0)), clearTimeout(i)),
          (i = setTimeout(function () {
            (i = null), (o.loadedSearches[s] = !0), t.call(o, s, n);
          }, e));
      };
    },
    et = (t, e, i) => {
  ...
  function at(t, e) {
    var i = Object.assign({}, W, e),
      ...
      u = t.getAttribute("placeholder") || t.getAttribute("data-placeholder");
    ...
    return (
      "select" === d
        ? ((h = y.options),
          ...
          V(t.children, (t) => {
            var e, i, s;
            "optgroup" === (p = t.tagName.toLowerCase())
              ? (((s = v((e = t)))[a] = s[a] || e.getAttribute("label") || ""),
                (s[c] = s[c] || f++),
                (s[r] = s[r] || e.disabled),
                y.optgroups.push(s),
                (i = s[c]),
  ...
  class dt extends (function (t) {
    return (
      ...
      class extends t {
        ...
        initializePlugins(t) {
          ...
          if (Array.isArray(t))
            t.forEach((t) => {
              "string" == typeof t
                ? n.push(t)
                : ((s.plugins.settings[t.name] = t.options), n.push(t.name));
            });
          else if (t)
            for (e in t)
              t.hasOwnProperty(e) &&
                ((s.plugins.settings[e] = t[e]), n.push(e));
        ...
        loadPlugin(e) {
          ...
          (s.requested[e] = !0),
            (s.loaded[e] = n.fn.apply(i, [i.plugins.settings[e] || {}])),
            s.names.push(e);
        }
        require(t) {
          var e = this,
    ...
    constructor(t, e) {
      ...
      (this.settings = n),
        ...
        (this.inputId = ot(s, "tomselect-" + ct)),
      ...
      "function" != typeof o &&
        ...
        o instanceof RegExp
          ? (n.createFilter = (t) => o.test(t))
          : (n.createFilter = (t) =>
              this.settings.duplicates || !this.options[t])),
      ...
      var p;
      if (
        (H(r, n.wrapperClass, d, u),
        H(l, n.controlClass),
        lt(r, l),
        H(a, n.dropdownClass, u),
        n.copyClassesToDropdown && H(a, d),
        H(c, n.dropdownContentClass),
        lt(a, c),
        $(n.dropdownParent || r).appendChild(a),
        j(n.controlInput))
      ) {
        p = $(n.controlInput);
        E(["autocorrect", "autocapitalize", "autocomplete"], (t) => {
          s.getAttribute(t) && Q(p, { [t]: s.getAttribute(t) });
        }),
          (p.tabIndex = -1),
          l.appendChild(p),
          (this.focus_node = p);
    ...
    setup() {
      const t = this,
        ...
        i = t.control_input,
        s = t.dropdown,
        n = t.dropdown_content,
        o = t.wrapper,
        l = t.control,
        a = t.input,
        c = t.focus_node,
        d = { passive: !0 },
        u = t.inputId + "-ts-dropdown";
      Q(n, { id: u }),
        Q(c, {
          role: "combobox",
      ...
      const p = ot(c, t.inputId + "-ts-control"),
        h =
          "label[for='" +
          ((t) => t.replace(/['"\\]/g, "\\$&"))(t.inputId) +
          "']",
      ...
      (null === e.maxItems || e.maxItems > 1) &&
        ...
        e.placeholder && Q(i, { placeholder: e.placeholder }),
        !e.splitOn &&
          e.delimiter &&
          (e.splitOn = new RegExp("\\s*" + r(e.delimiter) + "+\\s*")),
        e.load && e.loadThrottle && (e.load = tt(e.load, e.loadThrottle)),
        (t.control_input.type = a.type),
        st(s, "mousemove", () => {
          t.ignoreHover = !1;
        }),
        st(
        ...
        st(l, "click", (e) => {
          ...
          s && t.onItemSelect(e, s)
            ? it(e, !0)
            : "" == i.value && (t.onClick(), it(e, !0));
        }),
        st(c, "keydown", (e) => t.onKeyDown(e)),
        st(i, "keypress", (e) => t.onKeyPress(e)),
        st(i, "input", (e) => t.onInput(e)),
        st(c, "blur", (e) => t.onBlur(e)),
        st(c, "focus", (e) => t.onFocus(e)),
        st(i, "paste", (e) => t.onPaste(e));
      const v = (e) => {
          const n = e.composedPath()[0];
          if (!o.contains(n) && !s.contains(n))
            return t.isFocused && t.blur(), void t.inputState();
          n == i && t.isOpen ? e.stopPropagation() : it(e, !0);
        },
        m = () => {
          t.isOpen && t.positionDropdown();
        };
      st(document, "mousedown", v),
        st(window, "scroll", m, d),
        st(window, "resize", m, d),
        (this._destroy = () => {
        ...
        t.inputState(),
        (t.isSetup = !0),
        a.disabled ? t.disable() : t.enable(),
        t.on("change", this.onChange),
        H(a, "tomselected", "ts-hidden-accessible"),
    ...
    setupTemplates() {
      var t = this,
        ...
        s = {
          ...
          optgroup_header: (t, e) =>
            '<div class="optgroup-header">' + e(t[i]) + "</div>",
    ...
    sync(t = !0) {
      const e = this,
        i = t ? at(e.input, { delimiter: e.settings.delimiter }) : e.settings;
      e.setupOptions(i.options, i.optgroups),
        e.setValue(i.items || [], !0),
        (e.lastQuery = null);
    }
    onClick() {
      var t = this;
        ...
        : e.settings.splitOn &&
          setTimeout(() => {
            ...
            if (t.match(e.settings.splitOn)) {
              ...
              E(i, (t) => {
                X(t) && (this.options[t] ? e.addItem(t) : e.createItem(t));
              });
            }
          }, 0);
    }
    onKeyPress(t) {
      ...
      if (!e.isLocked) {
        ...
        return e.settings.create &&
          "multi" === e.settings.mode &&
          i === e.settings.delimiter
          ? (e.createItem(), void it(t))
          : void 0;
      }
      it(t);
    }
    onKeyDown(t) {
      ...
      if (((e.ignoreHover = !0), e.isLocked)) 9 !== t.keyCode && it(t);
        ...
        switch (t.keyCode) {
          case 65:
            if (nt(U, t) && "" == e.control_input.value)
              return it(t), void e.selectAll();
            break;
          case 27:
            return (
              e.isOpen && (it(t, !0), e.close()), void e.clearActiveItems()
            );
          case 40:
          ...
          case 38:
            ...
            return void it(t);
          case 13:
            return void (e.canSelect(e.activeOption)
              ? (e.onOptionSelect(t, e.activeOption), it(t))
              : ((e.settings.create && e.createItem()) ||
                  (document.activeElement == e.control_input && e.isOpen)) &&
                it(t));
          case 37:
          ...
          case 9:
            return void (
              e.settings.selectOnTab &&
              (e.canSelect(e.activeOption) &&
                (e.onOptionSelect(t, e.activeOption), it(t)),
              e.settings.create && e.createItem() && it(t))
            );
          case 8:
          case 46:
    ...
    onInput(t) {
      ...
      if (!e.isLocked) {
        ...
        e.lastValue !== i &&
          ((e.lastValue = i),
          e.settings.shouldLoad.call(e, i) && e.load(i),
          e.refreshOptions(),
          e.trigger("type", i));
      }
    }
    ...
    onFocus(t) {
      ...
      e.ignoreFocus ||
        ...
        e.activeItems.length ||
          (e.showInput(), e.refreshOptions(!!e.settings.openOnFocus)),
        e.refreshState());
    }
    onBlur(t) {
    ...
    onOptionSelect(t, e) {
      var i,
        s = this;
      (e.parentElement && e.parentElement.matches("[data-disabled]")) ||
    ...
    loadCallback(t, e) {
      ...
      (i.loading = Math.max(i.loading - 1, 0)),
        ...
        i.loading || N(i.wrapper, i.settings.loadingClass),
        i.trigger("load", t, e);
    }
    preload() {
          ...
          for (
            l = a.getLastActive(),
              (n = Array.prototype.indexOf.call(a.control.children, l)) >
                (o = Array.prototype.indexOf.call(a.control.children, t)) &&
                ((r = n), (n = o), (o = r)),
              s = n;
            s <= o;
            s++
          )
            (t = a.control.children[s]),
              -1 === a.activeItems.indexOf(t) && a.setActiveItemClass(t);
          it(e);
        } else
          ("click" === i && nt(U, e)) || ("keydown" === i && nt("shiftKey", e))
            ? t.classList.contains("active")
              ? a.removeActiveItem(t)
              : a.setActiveItemClass(t)
            : (a.clearActiveItems(), a.setActiveItemClass(t));
    ...
    clearActiveItems() {
      N(this.activeItems, "active"), (this.activeItems = []);
    }
    setActiveOption(t, e = !0) {
      t !== this.activeOption &&
        ...
        t &&
          ((this.activeOption = t),
          Q(this.focus_node, { "aria-activedescendant": t.getAttribute("id") }),
          Q(t, { "aria-selected": "true" }),
          H(t, "active"),
    ...
    scrollToOption(t, e) {
      ...
      const i = this.dropdown_content,
        ...
        n = i.scrollTop || 0,
        o = t.offsetHeight,
        r = t.getBoundingClientRect().top - i.getBoundingClientRect().top + n;
    ...
    inputState() {
      ...
      t.control.contains(t.control_input) &&
        (Q(t.control_input, { placeholder: t.settings.placeholder }),
        t.activeItems.length > 0 ||
        (!t.isFocused && t.settings.hidePlaceholder && t.items.length > 0)
          ? (t.setTextboxValue(), (t.isInputHidden = !0))
          : (t.settings.hidePlaceholder &&
              t.items.length > 0 &&
              Q(t.control_input, { placeholder: "" }),
            (t.isInputHidden = !1)),
    ...
    getSearchOptions() {
      var t = this.settings,
        e = t.sortField;
      return (
        "string" == typeof t.sortField && (e = [{ field: t.sortField }]),
        {
    ...
    search(t) {
      ...
      if (
        s.settings.score &&
        "function" != typeof (i = s.settings.score.call(s, t))
      )
        throw new Error(
      ...
      return (
        t !== s.lastQuery
          ? ((s.lastQuery = t),
            (e = s.sifter.search(t, Object.assign(n, { score: i }))),
            (s.currentResults = e))
          : (e = Object.assign({}, s.currentResults)),
        s.settings.hideSelected &&
    ...
    refreshOptions(t = !0) {
      ...
      var v,
        m = h.search(g),
        y = null,
        O = h.settings.shouldOpen || !1,
        b = h.dropdown_content;
      for (
        f && (y = h.activeOption) && (c = y.closest("[data-group]")),
          n = m.items.length,
        ...
        for (
          ...
          let t = u[o];
          void 0 === t && ((t = document.createDocumentFragment()), p.push(o)),
            i > 0 &&
              ((d = d.cloneNode(!0)),
      ...
      h.settings.lockOptgroupOrder &&
        p.sort((t, e) => {
          const i = h.optgroups[t],
            s = h.optgroups[e];
        ...
        h.settings.highlight &&
          ((v = b.querySelectorAll("span.highlight")),
      ...
      if (
        (h.loading
          ...
          ? 0 === m.items.length && w("no_results")
          : w("not_loading"),
        (a = h.canCreate(g)) && (d = w("option_create")),
        ...
        t && !h.isOpen && (h.open(), h.scrollToOption(y, "auto")),
          h.setActiveOption(y);
    ...
    addOption(t, e = !1) {
      ...
      return (
        ...
        ((t.$order = t.$order || ++i.order),
        (t.$id = i.inputId + "-opt-" + t.$order),
        (i.options[s] = t),
        (i.lastQuery = null),
        e && ((i.userOptions[s] = e), i.trigger("option_add", s, t)),
        s)
      );
    }
    addOptions(t, e = !1) {
    ...
    addOptionGroup(t, e) {
      ...
      (e[this.settings.optgroupValueField] = t),
        (i = this.registerOptionGroup(e)) && this.trigger("optgroup_add", i, e);
    }
    removeOptionGroup(t) {
    ...
    updateOption(t, e) {
      ...
      c &&
        ...
        (s = i._render("item", e)),
        c.classList.contains("active") && H(s, "active"),
        G(c, s)),
        (i.lastQuery = null);
    }
    removeOption(t, e) {
    ...
    getAdjacent(t, e, i = "option") {
      ...
      for (let i = 0; i < s.length; i++)
        if (s[i] == t) return e > 0 ? s[i + 1] : s[i - 1];
      return null;
    }
    getItem(t) {
      ...
      var e = X(t);
      return null !== e
        ? this.control.querySelector(`[data-value="${rt(e)}"]`)
        : null;
    }
    addItems(t, e) {
      var i = this,
    ...
    addItem(t, e) {
      et(this, e ? [] : ["change", "dropdown_close"], () => {
        ...
        if (
          ...
          ("single" === o && n.clear(e), "multi" !== o || !n.isFull())
        ) {
          if (
            ...
            n.isPending ||
              ...
              n.isPending || n.updateOriginalInput({ silent: e });
          }
    ...
    removeItem(t = null, e) {
      ...
      (s = K(t)),
        ...
        i.updateOriginalInput({ silent: e }),
        i.refreshState(),
        i.positionDropdown(),
        i.trigger("item_remove", o, t);
    }
    createItem(t = null, e = () => {}) {
      ...
      return (
        (i =
          "function" == typeof s.settings.create
            ? s.settings.create.call(this, t, r)
            : { [s.settings.labelField]: t, [s.settings.valueField]: t }),
        o || r(i),
        !0
      );
    }
    ...
    refreshState() {
      ...
      var n;
      s.toggle("focus", t.isFocused),
        s.toggle("disabled", t.isDisabled),
        s.toggle("required", t.isRequired),
        s.toggle("invalid", !t.isValid),
        s.toggle("locked", i),
        s.toggle("full", e),
        s.toggle("input-active", t.isFocused && !t.isInputHidden),
        s.toggle("dropdown-active", t.isOpen),
        s.toggle("has-options", ((n = t.options), 0 === Object.keys(n).length)),
        s.toggle("has-items", t.items.length > 0);
    }
    refreshValidityState() {
      var t = this;
      t.input.validity &&
        ((t.isValid = t.input.validity.valid), (t.isInvalid = !t.isValid));
    }
    isFull() {
      return (
    ...
    updateOriginalInput(t = {}) {
      ...
      if (e.is_select_tag) {
        ...
        function o(i, s, o) {
          return (
            i || (i = $('<option value="' + Z(s) + '">' + Z(o) + "</option>")),
            i != n && e.input.append(i),
            t.push(i),
        ...
        e.input.querySelectorAll("option:checked").forEach((t) => {
          ...
          0 == e.items.length && "single" == e.settings.mode
            ? o(n, "", "")
            : e.items.forEach((n) => {
                if (
                  ((i = e.options[n]),
                  (s = i[e.settings.labelField] || ""),
                  t.includes(i.$option))
                ) {
                  o(
                    e.input.querySelector(
                      `option[value="${rt(n)}"]:not(:checked)`
                    ),
                    n,
                    s
                  );
    ...
    open() {
      ...
      t.isLocked ||
        ...
        ((t.isOpen = !0),
        Q(t.focus_node, { "aria-expanded": "true" }),
        t.refreshState(),
        D(t.dropdown, { visibility: "hidden", display: "block" }),
        t.positionDropdown(),
        D(t.dropdown, { visibility: "visible", display: "block" }),
        t.focus(),
    ...
    close(t = !0) {
      ...
      t &&
        ...
        (e.isOpen = !1),
        Q(e.focus_node, { "aria-expanded": "false" }),
        D(e.dropdown, { display: "none" }),
        e.settings.hideSelected && e.clearActiveOption(),
        e.refreshState(),
        i && e.trigger("dropdown_close", e.dropdown);
    }
    positionDropdown() {
    ...
    deleteSelection(t) {
      ...
      if (r.activeItems.length)
        ...
        e < 0 && 0 === i.start && 0 === i.length
          ? (s = t[r.caretPos - 1])
          : e > 0 && i.start === r.inputValue().length && (s = t[r.caretPos]),
          void 0 !== s && l.push(s);
      }
      if (!r.shouldDelete(l, t)) return !1;
      for (it(t, !0), void 0 !== s && r.setCaret(s); l.length; )
        r.removeItem(l.pop());
    ...
    advanceSelection(t, e) {
      ...
      n.rtl && (t *= -1),
        n.inputValue().length ||
          (nt(U, e) || nt("shiftKey", e)
            ? (s = (i = n.getLastActive(t))
                ? i.classList.contains("active")
                  ? n.getAdjacent(i, t, "item")
                  : i
                : t > 0
    ...
    destroy() {
      ...
      t.trigger("destroy"),
        ...
        N(t.input, "tomselected", "ts-hidden-accessible"),
        t._destroy(),
    ...
    render(t, e) {
      ...
      if (
        ...
        "option" === t || "option_create" === t
          ? e[n.settings.disabledField]
            ? Q(s, { "aria-disabled": "true" })
            : Q(s, { "data-selectable": "" })
          : "optgroup" === t &&
            ((i = e.group[n.settings.optgroupValueField]),
            Q(s, { "data-group": i }),
            e.group[n.settings.disabledField] && Q(s, { "data-disabled": "" })),
        "option" === t || "item" === t)
      ) {
        const i = Y(e[n.settings.valueField]);
        Q(s, { "data-value": i }),
          "item" === t
            ? (H(s, n.settings.itemClass), Q(s, { "data-ts-item": "" }))
            : (H(s, n.settings.optionClass),
              Q(s, { role: "option", id: e.$id }),
              (e.$div = s),
              (n.options[i] = e));
      }
      return s;
    ...
    hook(t, e, i) {
      ...
      s[e] = function () {
        ...
        return (
          ...
          "instead" === t
            ? o
            : ("before" === t && (e = n.apply(s, arguments)), e)
        );
      };
    }
  }
...
var tomSelect = function (t, e) {
  return new TomSelect(t, e);
};
