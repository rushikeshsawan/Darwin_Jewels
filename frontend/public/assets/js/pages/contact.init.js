var contactData = [
  {
    id: 1,
    user: { img: "assets/images/users/avatar-1.jpg", name: "Danielle Wright" },
  ...
  {
    id: 2,
    user: { img: "assets/images/users/avatar-2.jpg", name: "Stephen Bird" },
  ...
  {
    id: 3,
    user: { img: "assets/images/users/avatar-3.jpg", name: "Jeffrey Hunt" },
  ...
  {
    id: 4,
    user: { img: "assets/images/users/avatar-4.jpg", name: "Michael Brown" },
  ...
  {
    id: 5,
    user: { img: "assets/images/users/avatar-5.jpg", name: "David Daly" },
  ...
  {
    id: 6,
    user: { img: "assets/images/users/avatar-5.jpg", name: "Terry White" },
  ...
  {
    id: 7,
    user: { img: "assets/images/users/avatar-7.jpg", name: "Daniel Gonzalez" },
  ...
  {
    id: 8,
    user: { img: "assets/images/users/avatar-8.jpg", name: "Stephen Garrison" },
    email: "stephen@example.com",
  ...
  {
    id: 9,
    user: { img: "assets/images/users/avatar-9.jpg", name: "Ashley Silva" },
  ...
  {
    id: 10,
    user: { img: "assets/images/users/avatar-10.jpg", name: "Charles Welch" },
  ...
  {
    id: 11,
    user: { img: "assets/images/users/avatar-1.jpg", name: "Aaron Bauer" },
  ...
  {
    id: 12,
    user: { img: "assets/images/users/avatar-2.jpg", name: "Heather Jimenez" },
  ...
  {
    id: 13,
    user: { img: "assets/images/users/avatar-3.jpg", name: "Scott Wilson" },
  ...
  {
    id: 14,
    user: { img: "assets/images/users/avatar-4.jpg", name: "James Wolfe" },
  ...
  {
    id: 16,
    user: { img: "assets/images/users/avatar-6.jpg", name: "Denise Bowers" },
  ...
  {
    id: 17,
    user: { img: "assets/images/users/avatar-7.jpg", name: "William Hensley" },
  ...
  {
    id: 18,
    user: { img: "assets/images/users/avatar-8.jpg", name: "Sharon Brewer" },
  ...
  {
    id: 19,
    user: { img: "assets/images/users/avatar-9.jpg", name: "Barbara Nelson" },
  ...
  {
    id: 20,
    user: { img: "assets/images/users/avatar-10.jpg", name: "Victoria Medina" },
  ...
  {
    id: 21,
    user: { img: "assets/images/users/avatar-1.jpg", name: "Stacy Martin" },
  ...
  {
    id: 22,
    user: { img: "assets/images/users/avatar-2.jpg", name: "Leslie Fink" },
  ...
  {
    id: 23,
    user: { img: "assets/images/users/avatar-3.jpg", name: "Sean Walker" },
  ...
  {
    id: 24,
    user: { img: "assets/images/users/avatar-4.jpg", name: "Kristen Gray" },
  ...
  {
    id: 25,
    user: { img: "assets/images/users/avatar-5.jpg", name: "Zachary Brown" },
  ...
  {
    id: 26,
    user: { img: "assets/images/users/avatar-6.jpg", name: "Dana Trevino" },
  ...
  {
    id: 27,
    user: { img: "assets/images/users/avatar-10.jpg", name: "Tonya Noble" },
...
function findNextId() {
  var e, a;
  return 0 === contactData.length
    ? 0
    : (e = fetchIdFromObj(contactData[contactData.length - 1])) <=
      (a = fetchIdFromObj(contactData[0]))
    ? a + 1
    : e + 1;
}
function editMemberList(e) {
  ...
  contactData = contactData.map(function (e) {
    return (
      e.id == a &&
        ((editlist = !0),
        (document.getElementById("addContactModalLabel").innerHTML =
          "Edit Contact"),
...
function overviewList() {
  ...
  (document.querySelector("#viewContactoffcanvas .overview-userimg").src = a),
    document
      .querySelectorAll("#viewContactoffcanvas .overview-name")
      .forEach(function (e) {
        e.innerHTML = t;
      }),
    (document.querySelector("#viewContactoffcanvas .overview-email").innerHTML =
      n),
    (document.querySelector("#viewContactoffcanvas .overview-phone").innerHTML =
      s),
    document
      .querySelectorAll("#viewContactoffcanvas .overview-location")
      .forEach(function (e) {
        e.innerHTML = i;
      }),
    (document.querySelector("#viewContactoffcanvas .overview-tags").innerHTML =
      e);
}
document.getElementById("recomended-jobs") &&
  ...
  document
    .querySelector("#contact-image-input")
  ...
  Array.from(document.querySelectorAll(".addContact-modal")).forEach(function (
    ...
    e.addEventListener("click", function (e) {
      (document.getElementById("addContactModalLabel").innerHTML =
        ...
        (document.getElementById("contact-img").src =
          "assets/images/users/user-dummy-img.jpg"),
        document
          .getElementById("contactlist-form")
...
searchProductList.addEventListener("keyup", function () {
  ...
  Array.from(document.querySelectorAll(".contact-menu-list a")).forEach(
    function (n) {
      n.addEventListener("click", function () {
        n.querySelector(".menu-list-link").hasAttribute("data-tab")
          ? (e =
              "all" !=
              (a = n.querySelector(".menu-list-link").getAttribute("data-tab"))
                ? contactData.filter((e) => e.tab === a)
                : contactData)
          : n.querySelector(".menu-list-link").hasAttribute("data-label") &&
            ((a = n
              .querySelector(".menu-list-link")
