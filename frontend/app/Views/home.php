...
<main id="content">
    ...
    <section class="pt-lg-13 pt-10">
        <div class="container container-xl">
            <div class="row mb-md-6 mb-8">
                <div class="col-md-6">
                    <h2 class="fs-34" data-animate="fadeInUp">Shop By Category</h2>
                </div>
                <div class="col-md-6 text-md-right">
                    <!-- <a href="shop-page-04.html" class="btn btn-link p-0 mt-2">Shop All Products<i
    ...
    <section class="py-lg-13 py-11">
        <div class="container container-xl text-center">
            ...
            <h2 class="mw-675 mx-auto mb-4" data-animate="fadeInUp">Featured Collection
            </h2>
            <p class="fs-15 font-weight-600 text-uppercase letter-spacing-01 text-secondary mb-7">Let's Take a
                Glimpse of our trending collections before diving in! </p>
            <div class="row">
                <?php foreach ($Collection as $row) : ?>
                    <div class="col-lg-3 col-md-6">
                        <div class="card border-0 mb-lg-0 mb-6" data-animate="fadeInUp">
                            <a href="" class="hover-zoom-in hover-shine"><img src="<?= base_url('/uploads/collection/' . $row['image']) ?>" alt="<?= $row['image']; ?>"></a>
                            <div class="card-body text-center">
                                <h4 class="card-title mb-1"><a href=""><?= $row['FeaturedCollection']; ?></a></h4>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
    ...
    <section data-animated-id="7" style="border: 1px solid#edf1f0;">
        <div class="row flex-img-row-reverse  mx-0">
            <div class="col-lg-6 py-xl-17 py-lg-12 py-8" style="background-color: #EDF1F0">
                <div class="mw-lg-695 ml-auto py-lg-7">
                    <div class="fs-15 font-weight-600 text-uppercase letter-spacing-01 pb-4 text-secondary">Seasonal
                        Collections</div>
                    <h2 class="fs-40">Jewelry Inspired<br>
                        By Beauty</h2>
                    <p class="mb-0 fs-18 pt-1 text-body">A necklace is a piece of jewelry that is worn around the
                        neck.</p>
            ...
            <div class="col-lg-6  d-flex align-items-center justify-content-center py-lg-0 py-md-17 py-13 ">
                <img src="images/banner/banner-02.png" alt="">
            </div>
        </div>
    </section>
                        ...
                        <div class="tab-pane fade " id="pills-Bodycare" role="tabpanel" aria-labelledby="pills-Bodycare-tab">
                            <div class="row">
                                <div class="col-lg-3 col-sm-6 mb-5" data-animate="fadeInUp">
                                    <div class="card border-0 product">
                                        <div class="position-relative">
                                            <img src="images/earing/01/1.jpg" alt="Coffee Bean Caffeine Eye Cream">
                                            <div class="card-img-overlay d-flex p-3">
                                                <div>
                                                </div>
                                                <div class="my-auto w-100 content-change-vertical">
                                ...
                                <div class="col-lg-3 col-sm-6 mb-5" data-animate="fadeInUp">
                                    <div class="card border-0 product">
                                        <div class="position-relative">
                                            <img src="images/Necklaces/1/Necklaces_1_500x500.jpg" alt="Bio-shroom Rejuvenating Serum">
                                            <div class="card-img-overlay d-flex p-3">
                                                <div>
                                                </div>
                                                <div class="my-auto w-100 content-change-vertical">
                                ...
                                <div class="col-lg-3 col-sm-6 mb-5" data-animate="fadeInUp">
                                    <div class="card border-0 product">
                                        <div class="position-relative">
                                            <img src="images/rings/IMG_20230220_151153.jpg" alt="Coffee Bean Caffeine Eye Cream">
                                            <div class="card-img-overlay d-flex p-3">
                                                <div>
                                                </div>
                                                <div class="my-auto w-100 content-change-vertical">
        ...
        <div class="container container-xl">
            <div class="row">
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-transparent border-0 align-items-center text-center mb-xl-0 mb-6 fadeInUp animated" data-animate="fadeInUp">
                        <div class="card-img">
