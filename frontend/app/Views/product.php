                                        ...
                                        <div class="card-img-overlay d-flex p-3 flex-column">
                                            <div class="mb-auto d-flex justify-content-center">
                                                ...
                                                <div class="w-100 content-change-vertical">
                                                    <a href="#" data-toggle="tooltip" data-placement="left" title="Add to wishlist" class="add-to-wishlist ml-auto d-flex align-items-center justify-content-center text-secondary bg-white hover-white bg-hover-secondary w-40px h-40px rounded-circle mb-2">
                                                        <svg class="icon icon-star-light fs-20">
                                                            <use xlink:href="#icon-star-light"></use>
                                                        </svg>
                                                    </a>
                                                    <a href="#" data-toggle="tooltip" data-placement="left" title="Quick view" class="preview ml-auto d-md-flex align-items-center justify-content-center cursor-pointer text-secondary bg-white hover-white bg-hover-secondary w-40px h-40px rounded-circle mb-2 d-none">
                                                    ...
                                                    <a href="#" data-toggle="tooltip" data-placement="left" title="View Product" class="preview ml-auto d-md-flex align-items-center justify-content-center cursor-pointer text-secondary bg-white hover-white bg-hover-secondary w-40px h-40px rounded-circle mb-2 d-none">
                                                        <span data-toggle="modal" data-target="#View Product">
                                                            <svg class="icon icon-shopping-bag-open-light fs-20">
                                            ...
                                            <div class="text-center">
                                                <a href="shopping-cart.html" class="btn btn-secondary bg-hover-primary border-hover-primary lh-12">Add To Bag</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body pt-4 text-center px-0">
                                        <p class="card-text font-weight-bold fs-16 mb-1 text-secondary">
                                            <!-- <span class="fs-13 font-weight-500 text-decoration-through text-body pr-1">₹ 3,58,755</span> -->
                                            <span>₹<?= $row->prize; ?></span>
                                        </p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 pl-xl-6 pr-xl-8">
                        <p class="d-flex align-items-center mb-3">
                            <span class="text-line-through">₹ 3,58,755</span>
                            <span class="fs-18 text-secondary font-weig69-bold ml-3">₹ 3,58,755</span>
                        ...
                        <p class="mb-4 mr-xl-6">Niacinamide and Vitamin C are two anti-aging superstars but not
                            usually formulated
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
 <!-- Add this JavaScript code at the end of the HTML page or in a separate JS file -->
<script>
    function getProducts(category_id) {
        $.ajax({
            ...
            success: function(response) {
                // Verify that the response data is received correctly
                console.log(response);

                // Populate the products in the productContainer
                var html = '';
                $.each(response, function(index, item) {
                    // Generate product card HTML dynamically using the item data
                    // Adapt this code based on your product card structure
                    ...
                    // Add the rest of your product card HTML here...
                    html += '            </div>';
                    html += '        </div>';
                    // Add the rest of your product card HTML here...
                    html += '    </div>';
