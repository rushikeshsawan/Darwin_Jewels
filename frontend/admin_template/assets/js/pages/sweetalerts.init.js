    ...
    document
      ...
      .addEventListener("click", function () {
        Swal.fire({
          ...
          buttonsStyling: !1,
          background:
            "var(--tb-secondary-bg) url(assets/images/chat-bg-pattern.png)",
        });
      }),
