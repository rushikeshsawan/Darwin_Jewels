...
<body>
    ...
    <div id="layout-wrapper">
                        ...
                        <div class="dropdown topbar-head-dropdown topbar-tag-dropdown justify-content-end">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language py-2"
                                    ...
                                    <img src="/assets/images/flags/us.svg" alt="user-image" class="me-2 rounded-circle"
                                        height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ar"
                                    title="Arabic">
                                    <img src="/assets/images/flags/ae.svg" alt="user-image" class="me-2 rounded-circle"
                                        height="18">
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="back-btn">
                <a href="index.html" class="btn btn-primary p-0 avatar-sm rounded-circle" data-bs-toggle="tooltip"
                    data-bs-title="Back to Dashboard">
