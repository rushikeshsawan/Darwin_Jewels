...
=======
    <title>Nestable List | Hybrix - Admin & Dashboard Template</title>
>>>>>>> 29f8a3b4fa91203b78951bc36a687aad21b112b9
    ...
    <!-- App favicon -->
<<<<<<< HEAD
    <link rel="shortcut icon" href="http://localhost/Darwin_Jewels/frontend/admin_template/assets/images/favicon.ico"> 
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/js/layout.js"></script> 
    <link href="http://localhost/Darwin_Jewels/frontend/admin_template/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" /> 
    <link href="http://localhost/Darwin_Jewels/frontend/admin_template/assets/css/icons.min.css" rel="stylesheet" type="text/css" /> 
    <link href="http://localhost/Darwin_Jewels/frontend/admin_template/assets/css/app.min.css" rel="stylesheet" type="text/css" /> 
    <link href="http://localhost/Darwin_Jewels/frontend/admin_template/assets/css/custom.min.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="http://localhost/Darwin_Jewels/frontend/admin_template/assets/cdn.datatables.net/1.11.5/css/dataTables.bootstrap5.min.css" /> 
    <link rel="stylesheet" href="http://localhost/Darwin_Jewels/frontend/admin_template/assets/cdn.datatables.net/responsive/2.2.9/css/responsive.bootstrap.min.css" /> 
    <link rel="stylesheet" href="http://localhost/Darwin_Jewels/frontend/admin_template/assets/cdn.datatables.net/buttons/2.2.2/css/buttons.dataTables.min.css">
=======
...
<<<<<<< HEAD
    ...
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/libs/simplebar/simplebar.min.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/js/pages/plugins/lord-icon-2.1.0.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/js/plugins.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/js/pages/password-addon.init.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/js/pages/form-validation.init.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/js/pages/passowrd-create.init.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/code.jquery.com/jquery-3.6.0.min.js" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script> 
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/cdn.datatables.net/1.11.5/js/jquery.dataTables.min.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/cdn.datatables.net/1.11.5/js/dataTables.bootstrap5.min.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/cdn.datatables.net/responsive/2.2.9/js/dataTables.responsive.min.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/cdn.datatables.net/buttons/2.2.2/js/dataTables.buttons.min.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/cdn.datatables.net/buttons/2.2.2/js/buttons.print.min.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/cdn.datatables.net/buttons/2.2.2/js/buttons.html5.min.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/vfs_fonts.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/pdfmake.min.js"></script>
    <script src="http://localhost/Darwin_Jewels/frontend/admin_template/assets/cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js"></script>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="slider">
                                <i class="bi bi-command"></i> <span data-key="t-overview">Slider</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="marketing">
                                <i class="bi bi-command"></i> <span data-key="t-overview">Marketing</span>
                            </a>
                        </li>  
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="logout">
                                <i class="bi bi-command"></i> <span data-key="t-overview">Logout</span>
                            </a>
                        </li>
                    </ul>
                </div>
